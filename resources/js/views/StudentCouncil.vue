            ...
            <form v-on:submit.prevent="createRegisterStudentCouncil">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input accept="image/png,image/jpeg" type="file" v-on:change="attachImage" ref="imageStudentCouncil" class="form-control" id="image"/>
            ...
            <form v-on:submit.prevent="updateRegisterStudentCouncil">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input accept="image/png,image/jpeg" type="file" v-on:change="updateImage" ref="updateImageStudentCouncil" class="form-control" id="image"/>
                        <div class="invalid-feedback-validation" v-if="errors.image">{{errors.image[0]}}</div>                    
                    </div>
                </div>
                <hr>
